defmodule BlockScoutWeb.ViewingAddressesTest do
  ...
  describe "viewing token balances" do
    setup do
      ...
      insert(:address_current_token_balance, address: lincoln, token_contract_address_hash: contract_address.hash, token_type: "ERC-721")
      ...
      insert(:address_current_token_balance, address: lincoln, token_contract_address_hash: contract_address_2.hash, token_type: "ERC-20")
